...
import { createCateringAppointment } from "@/actions/appointment";
import Container from "@/components/globals/container";
import { Badge } from "@/components/ui/badge";
import { Button } from "@/components/ui/button";
import { formatPrice } from "@/lib/utils";
import { Catering, User } from "@prisma/client";
...
const Step4 = ({
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const result = await createCateringAppointment(
        step3Data.start,
        step3Data.end,
        step3Data.guest,
        userData?.id as string,
        cateringData?.id as string,
        step3Data.price,
  ...
  return (
    <div className="mt-10">
      <Container>
        <p className="text-2xl font-bold"> Catering Appointment Summary</p>
        <div className="grid grid-cols-10 mt-5">
          <div className="col-span-4">
            ...
            <div className="space-y-1">
              ...
              <p>Catering Name: {step3Data.room}</p>
              <p>
